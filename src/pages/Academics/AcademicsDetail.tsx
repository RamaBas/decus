    ...
    <div className="bg-gray-50 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">{academic.name && (academic.name)}</h2>
        ...
        <div className="space-y-8">
          {/* Galería de imágenes */}
          <div className="relative group cursor-pointer" onClick={() => openCarousel(0)}>
            <img
              src={academic.photoUrl[0]}
              alt={academic.name}
              className="w-full h-64 object-cover rounded-xl shadow-lg transform transition-transform duration-300 group-hover:scale-95"
            />
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <span className="text-white text-lg font-semibold flex items-center">
                Ver galería <ChevronRight className="ml-2 h-5 w-5" />
              </span>
            </div>
          </div>
          {/* Tarjeta de Actividades */}
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Actividades en DECUS</h3>
            <ReactMarkdown>
              {academic.cvUrl}
            </ReactMarkdown>
          </div>
